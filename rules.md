...
**6.3**: Запрещено создавать неубиваемую или почти неубиваемую технику или авиацию. 
**Наказание**: 1 предупреждение.

**6.4**: Запрещено использовать ствольные орудия в переносных установках (исключение: историчное вооружение). 
**Наказание**: 1 предупреждение.

**6.5**: Запрещено использовать инструменты ACE на технике и авиации из других аддонов (уточнение: ставить орудия, ракеты, броню, вспомогательные средства (радары, лтц)).
**Наказание**: 1 предупреждение.

**6.6**: Запрещено ставить более двух установок на стационарную реактивную артиллерию.
**Наказание**: 1 предупреждение.

**6.7**: Запрещено использовать Refil в наземной технике, авиации и стационарных или переносных установках.
**Наказание**: 1 предупреждение.

**6.8**: Запрещено ставить на колёсную технику больше 70мм брони(исключение: историчная броня). 
